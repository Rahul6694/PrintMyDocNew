...
export default function FinalCta() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 py-14 sm:py-20 text-center">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to modernize your print counter?</h2>
      ...
      <Link
        href="/register"
        className="inline-block rounded-xl px-6 sm:px-8 py-3.5 sm:py-4 font-semibold text-white bg-gradient-to-r from-accent-500 to-success hover:opacity-90 transition-opacity"
      >
        Join as a Merchant →
      </Link>
